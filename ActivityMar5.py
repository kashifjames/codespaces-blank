...
#keword
#check for age height
#comparison aparators less than,greater than check for age and height
#we need to write a function
# we need to quameters-height and up
#we need an error if data eneterd incorrectly

def check_roller coaster_slightly(age,height;)
if age>=14 and height>=5.2
 elif age print(you can get on the roller)


elif
    print(error,please try again,the information you provided you may not be connection)

#user cant be atleast 5.2 or taller and atleast 14 years old or older
#is order to ride roller coaster 1
def
#
