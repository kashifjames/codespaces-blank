...
#Complexity is the measure of resoures intensive a program can be 
#abstraction is the process of hiding?masking complexity
 
#4. What does it mean when you encounter a syntax error?
# when your not using the proper program to make your sentence 
...
Function definition--> that would only run when called 

Function call-->excutes the instructions 



#8. Describe what each symbol means?
single double sign = assignment
career=engineer
score=60
...
(pencils,notebook,paper,folder,bookbagitemprice=(1,00 2,00,3,00.50))

# 12. What are the Three (3) naming formats we use for naming variables, files, and functions?
camel case' first letter is lowercase but every new word is uppercase 
pascal case-everyword is uppercased 
